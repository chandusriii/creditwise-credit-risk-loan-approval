...
def train_creditwise_model():
    ...
    if df[target].dtype == "object":
        target_map = {"Approved": 1, "Rejected": 0, "approved": 1, "rejected": 0, "1": 1, "0": 0}
    ...
    education_pipe = Pipeline([
        ...
        ("encoder", OrdinalEncoder(categories=[["Graduate", "Postgraduate", "Undergraduate"]],
...
with st.form("creditwise_form"):
    ...
    education_level = c3.selectbox("Education Level", ["Graduate","Postgraduate","Undergraduate"])
    gender = c4.selectbox("Gender", ["Male","Female"])
    c1,c2 = st.columns(2)
    employer_category = c1.selectbox("Employer Category", ["Govt","Private","Self"])
    property_area = c2.selectbox("Property Area", ["Urban","Semi-Urban","Rural"])
    ...
    loan_purpose = c4.selectbox("Loan Purpose", ["Home","Education","Personal","Business"])
